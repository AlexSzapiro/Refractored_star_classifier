...
demo = sclas.SClas('demo_digits_rf')
...
#===================================================================================================
classifier_params = {'features': list(range(encoder_params['n_components'])), 'labels': list(range(1))}
classifier_method = sclas.classifier.ExtraRandomForestClassifier(classifier_params)
